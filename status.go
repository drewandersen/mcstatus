...
func (c *Client) GetMaxPlayerCount() (int, error) {
	status, err := c.getData()
	if err != nil {
		return 0, err
	}
...
func (c *Client) GetActivePlayerCount() (int, error) {
	status, err := c.getData()
	if err != nil {
		return 0, err
	}
...
func (c *Client) GetMotd() (string, error) {
	status, err := c.getData()
	if err != nil {
		return "", err
	}
...
func (c *Client) getData() (*status, error) {
